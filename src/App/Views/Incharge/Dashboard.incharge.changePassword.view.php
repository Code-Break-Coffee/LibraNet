...
<div class="flex-1 bg-white dark:bg-[#090A0C] ml-16 text-gray-900 dark:text-white h-screen">
    ...
    <main class="container mx-auto px-4 py-8 relative">
        ...
        <div class="flex justify-center items-center min-h-[70vh]">
            <form class="max-w-lg bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md min-w-[500px]" action="/incharge-change-password" method="post">
                <h2 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-300">Change Password</h2>
                <input type="hidden" name="_method" value="PUT"/>
                <div class="relative">
                    <input type="password" name="curr_pass" placeholder="Current Password" class="w-full mb-2 p-2 rounded border dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                    <?=loadComponent("EyeIcons",["position" => "right-2 top-3"]) ?>
                </div>
                <div class="relative">
                    <input type="password" name="new_pass" placeholder="New Password" class="w-full mb-2 p-2 rounded border dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                    <?=loadComponent("EyeIconsNew",["position" => "right-2 top-3"]) ?>
                </div>
                <div class="relative">
                    <input type="password" name="conf_pass" placeholder="Confirm New Password" class="w-full mb-2 p-2 rounded border dark:border-gray-600 dark:bg-gray-700 dark:text-white">
