<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-l-2 dark:bg-[#101623] p-6 rounded-lg shadow-sm">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-gray-600 dark:text-gray-300">Total Books</h2>
                    ...
                    <div class="bg-l-2 dark:bg-[#101623] p-6 rounded-lg shadow-sm">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-gray-600 dark:text-gray-300">Active Members</h2>
                    ...
                    <div class="bg-l-2 dark:bg-[#101623] p-6 rounded-lg shadow-sm">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-gray-600 dark:text-gray-300">Non Available Books</h2>
                    ...
                    <div class="bg-l-2 dark:bg-[#101623] p-6 rounded-lg shadow-sm">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-gray-600 dark:text-gray-300">Total Transactions</h2>
