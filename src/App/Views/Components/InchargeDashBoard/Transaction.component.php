<div class="bg-l-2 p-6 rounded-lg dark:bg-[#101623] shadow-sm">
    ...
    <p class="text-gray-600 mb-4">Latest book checkouts and returns</p>
    <ul>
        <?php foreach ($recentTransactionBooks as $transaction): ?>
            <li class="flex justify-between items-center mb-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-800 font-semibold"><?= htmlspecialchars($transaction->Title) ?? "" ?></p>
                        <p class="text-gray-600"><?= htmlspecialchars($transaction->Author1) ?? "" ?></p>
                    </div>
                </div>
